<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('precioSinIva') }}
            {{ Form::text('precioSinIva', $product->precioSinIva, ['class' => 'form-control' . ($errors->has('precioSinIva') ? ' is-invalid' : ''), 'placeholder' => 'Preciosiniva']) }}
            {!! $errors->first('precioSinIva', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('stock') }}
